...
const sequence: Record<ChapterId, string[]> = {
  ...
  rendering: ['rendering-studies'], brands: ['biyuan', 'yelisi', 'periastra'],
  ai: ['lensflow', 'yantai', 'xintiao', 'formline', 'resume-formatter', 'visual-archive', 'aesthetic-atlas', 'image-2-5-xhs', 'xhs-methods', 'yuju'],
}
