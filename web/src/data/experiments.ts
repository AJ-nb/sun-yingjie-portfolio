...
export const experiments: Record<string, Experiment> = {
  ...
  'huhu-care': {
    ...
    boundary: b('儿童呼气体验概念 · 医疗检测路线、临床适用性与实际易用性待后续项目确认。', 'Child exhalation experience concept · Detection technology, clinical use and usability remain future study topics.'),
    views: [
  ...
  periastra: {
    ...
    intro: b('比较选定的字体标志方向与两项探索，再检查缩放和反转。', 'Compare the selected wordmark direction with two explorations, then inspect scale and inversion.'),
    boundary: b('字体标志方向已选定；研究稿同步记录应用逻辑与实体工艺方向。', 'The wordmark direction is selected; the study records its application logic and production direction.'),
    views: [
      { id: 'mark', label: b('选定字体标志方向', 'Selected wordmark direction'), title: b('让品牌名称成为图形', 'Make the name the graphic'), body: b('PERIASTRA 字母在紧凑轮廓中连续组织。圆角、开口和转折构成节奏，完整名称成为主要识别资产；研究稿同步记录应用逻辑。', 'PERIASTRA is organized within a compact silhouette. Rounded strokes, openings and turns establish rhythm, making the name the primary identity asset; the study records its application logic.'), image: periastra + 'final-wordmark.png', caption: b('2026-06-09 选定方向研究稿；记录应用逻辑与工艺方向。', 'Selected direction study dated 9 June 2026; application logic and production direction recorded.') },
      { id: 'structure', label: b('P 图形探索', 'P exploration'), title: b('聚焦与保护的直接联想', 'Direct associations of focus and protection'), body: b('P、镜头与外框建立多层含义。比较时关注内部复杂度和品牌名称是否被弱化，这一方向保留为历史探索。', 'P, lens and enclosure create multiple associations. Comparison focuses on complexity and whether the name becomes secondary. This remains a historical exploration.'), image: periastra + 'logo/periastra-logo-v01-20260422.webp', caption: b('早期 P 标志，非选定方向。', 'Earlier P mark, not the selected direction.') },
