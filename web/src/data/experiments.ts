...
export const experiments: Record<string, Experiment> = {
  ...
  periastra: {
    ...
    boundary: b('字体标志方向已选定；商业采用与实体工艺仍需项目确认和样片验证。', 'The wordmark direction is selected; commercial adoption and production still require project confirmation and physical samples.'),
    views: [
      { id: 'mark', label: b('选定字体标志方向', 'Selected wordmark direction'), title: b('让品牌名称成为图形', 'Make the name the graphic'), body: b('PERIASTRA 字母在紧凑轮廓中连续组织。圆角、开口和转折构成节奏，完整名称成为主要识别资产；商业采用状态仍待核验。', 'PERIASTRA is organized within a compact silhouette. Rounded strokes, openings and turns establish rhythm, making the name the primary identity asset; commercial adoption remains unverified.'), image: periastra + 'final-wordmark.png', caption: b('2026-06-09 选定方向研究稿；商业采用状态待核验。', 'Selected direction study dated 9 June 2026; commercial adoption remains unverified.') },
