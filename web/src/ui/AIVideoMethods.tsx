...
export default function AIVideoMethods({lang}:{lang:Lang}) {
  ...
  return <article className="methods-page">
    ...
    <section id="methods"><div className="methods-section-title"><h2>{lang==='zh'?'八个问题，八种控制方法。':'Eight questions. Eight control methods.'}</h2><p>{lang==='zh'?'以下是对源文档的分析与设计迁移建议。未将参考视频视为本人作品，也未宣称已复测这些方法。':'These are source-document analyses and design-transfer proposals. Reference films are not personal work, and these methods are not claimed as personally retested.'}</p></div>
