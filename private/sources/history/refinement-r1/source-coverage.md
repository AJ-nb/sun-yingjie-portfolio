...
来源原件核对快照：`2026-09-14T17:09:27.018557+00:00`；最终本地构建快照：`2026-09-14T18:12:46.037462+00:00`。范围为本项目现有来源清单、当前60份案例Markdown及最终本地构建；不声称覆盖整台电脑或GitHub账户中的所有项目。
...
最终本地构建实际选择 **164 项媒体资产，共 55,397,915 字节（52.83 MiB）**。本文“公开版”指已纳入该本地构建的资产；远端部署结果由主代理交付记录提供。
...
| --- | --- | ---: | ---: | --- |
| 作品集 | `deliverables/portfolio/sun-yingjie-portfolio.pdf` | 16,945,554 | 40 | `8eea4aaad110` |
| 简历 | `deliverables/resume/sun-yingjie-resume.pdf` | 302,562 | 1 | `24a0493a665b` |
| 简历 | `deliverables/resume/sun-yingjie-resume.docx` | 38,551 | 可编辑DOCX | `1ade71bcd665` |
